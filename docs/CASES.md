...
| `cgroup-escape` | setsid, env {}, cwd /, silent exit | the cgroup net (Linux only) | v0.1.0, [94aaae3](https://github.com/maximilliangrand/nightshift/commit/94aaae3) | red team |
| `codex-budget-blower` | speaks codex JSONL, spends without limit | --budget with --adapter codex; running totals replace, never sum | v0.1.0, [77287f1](https://github.com/maximilliangrand/nightshift/commit/77287f1) | design |
| `openclaw-budget-blower` | reports $50 of usage at the end | --budget with --adapter openclaw; the JSON envelope is priced when it lands | v0.1.0, [e96f6ad](https://github.com/maximilliangrand/nightshift/commit/e96f6ad) | design |
| `openclaw-transcript-blower` | spends in the gateway, prints nothing | --budget via the session transcript tailer, before the envelope | v0.1.0, [e96f6ad](https://github.com/maximilliangrand/nightshift/commit/e96f6ad) | design |
<!-- /cases:table -->
...
<!-- cases:history -->
v0.1.0: 13 → 16 → 20 → 21 → 20 → 22 → 21 → 22 → 24
<!-- /cases:history -->
