...
| `openclaw-budget-blower` | reports $50 of usage at the end | --budget with --adapter openclaw; the JSON envelope is priced when it lands | v0.1.0, pending | design |
| `openclaw-transcript-blower` | spends in the gateway, prints nothing | --budget via the session transcript tailer, before the envelope | v0.1.0, pending | design |
<!-- /cases:table -->
...
<!-- cases:history -->
v0.1.0: 13 → 16 → 20 → 21 → 20 → 21 → 22 → 24
<!-- /cases:history -->
